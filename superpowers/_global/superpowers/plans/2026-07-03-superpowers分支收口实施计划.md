...
- Approved spec: `/mnt/f/IdeaProjects/goto-software/goto-docs/superpowers/_global/superpowers/specs/2026-07-03-superpowers分支收口设计.md`
- Plan path: `/mnt/f/IdeaProjects/goto-software/goto-docs/superpowers/_global/superpowers/plans/2026-07-03-superpowers分支收口实施计划.md`
...
```text
/mnt/f/IdeaProjects/goto-software/goto-docs/superpowers/_global/superpowers/specs/2026-07-03-superpowers分支收口设计.md
/mnt/f/IdeaProjects/goto-software/goto-docs/superpowers/_global/superpowers/plans/2026-07-03-superpowers分支收口实施计划.md
...
| goto-superpowers-docs | `/mnt/f/IdeaProjects/goto-software/goto-docs` | `main` | `f4822a6` | `main` | `/mnt/f/IdeaProjects/goto-software/goto-docs` | `reused-dirty-needs-controller` |
...
```bash
git -C /mnt/f/IdeaProjects/goto-software/goto-docs status --short --branch
git -C /mnt/f/IdeaProjects/goto-software/goto-docs log --oneline -5
```
...
- [ ] Execution mode: `controller inline`
- [ ] `--cd`: `/mnt/f/IdeaProjects/goto-software/goto-docs`
...
```bash
git -C /mnt/f/IdeaProjects/goto-software/goto-docs add _global/superpowers/plans/2026-07-03-superpowers分支收口实施计划.md
git -C /mnt/f/IdeaProjects/goto-software/goto-docs commit -m "docs: 增加superpowers分支收口实施计划"
```
...
```bash
git -C /mnt/f/IdeaProjects/goto-software/goto-docs status --short --branch
git -C /mnt/f/IdeaProjects/goto-software/goto-docs show --stat --oneline --no-renames HEAD
```
